...
// This tells us how each edge is defined
constexpr int edge_vertex_indices[12][2] = {
	{0, 1},
	{1, 3},
	{3, 2},
	{2, 0},
...
// Edge mask table (maps cube-index to which edges are intersected) — 256 entries
...
// Triangle table. For each of the 256 cases, up to 16 entries (triangles), terminated by -1
